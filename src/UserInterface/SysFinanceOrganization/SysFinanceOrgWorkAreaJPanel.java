 ...
 * @author hyf
 */
public class SysFinanceOrgWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public SysFinanceOrgWorkAreaJPanel(JPanel userProcessContainer, UserAccount user, SysFinanceOrganization financeOrganization) {
        initComponents();
    ...
    private void initComponents() {
        ...
        checkoutJButton.setText("pay supplier");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(checkoutJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ViewJPanel vjp = new ViewJPanel(userProcessContainer, user, financeOrganization);
    ...
    private void checkoutJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkoutJButtonActionPerformed
        ...
        PaySupplierJPanel psjp = new PaySupplierJPanel(userProcessContainer, user, financeOrganization);
        userProcessContainer.add("ViewProductDetailJPanel", psjp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
