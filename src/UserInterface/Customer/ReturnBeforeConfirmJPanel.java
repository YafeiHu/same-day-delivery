 ...
 * @author hyf
 */
public class ReturnBeforeConfirmJPanel extends javax.swing.JPanel {
    ...
    public ReturnBeforeConfirmJPanel(JPanel userProcessContainer, Order order, OrderItem orderItem, UserAccount user, AmazonSystem system) {
        initComponents();
