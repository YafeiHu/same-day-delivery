 ...
 * @author hyf
 */
public class ChangeProductJPanel extends javax.swing.JPanel {
    ...
    UserAccount user;
    OrderItem orderItem;
    ChangeRequest returnRequest;

    public ChangeProductJPanel(JPanel userProcessContainer, Order order, OrderItem orderItem, UserAccount user, AmazonSystem system) {
        initComponents();
        ...
        this.user = user;
        returnRequest = new ChangeRequest();
