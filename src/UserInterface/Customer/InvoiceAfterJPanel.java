 ...
 * @author hyf
 */
public class InvoiceAfterJPanel extends javax.swing.JPanel {
    ...
    UserAccount user;
    Invoice invoice;
    public InvoiceAfterJPanel(JPanel userProcessContainer, Order order, UserAccount user, AmazonSystem system) {
        initComponents();
 ...
 public void  showMoney() {
     ...
     Order o=invoice.getOrder();
     ordernumjLabel2.setText(String.valueOf(o.getOrderNum()));
     subtotalJLabel1.setText(String.valueOf(o.getSubtotalPrice()));
     shippingJLabel2.setText(String.valueOf(o.shipping()));
     taxJLabel2.setText(String.valueOf(o.tax()));
     totalJLabel3.setText(String.valueOf(o.totalMoney()));
    ...
    private void initComponents() {
        ...
        ordernumjLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    private void checkoutJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkoutJButtonActionPerformed
        ...
        userProcessContainer.add("4", cwjp);
