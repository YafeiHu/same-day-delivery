...
public class ComplaintJPanel extends javax.swing.JPanel {
    ...
    public ComplaintJPanel(JPanel userProcessContainer, Order order, OrderItem orderItem, UserAccount user, AmazonSystem system) {
        initComponents();
    ...
    private void checkoutJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkoutJButtonActionPerformed
        ...
        user.getWorkQueue().add(complainRequest);
        for (Organization o : system.getOrganizationDirectory().getOrganizationList()) {
            if (o instanceof SysCustomerServiceOrganization) {
                ((SysCustomerServiceOrganization) o).getWorkQueue().add(complainRequest);
            }
        }
        InvoiceJPanel ijp = new InvoiceJPanel(userProcessContainer, order, user, system);
        userProcessContainer.add("5", ijp);
    ...
    private void reasonJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reasonJComboBoxActionPerformed
        ...
        complainRequest.setReason(reason);
        complainRequest.setDescribe(reviewJTextArea1.getText());
        complainRequest.setSender(user);
        complainRequest.setStatus("under processing");
        complainRequest.setRequestDate(new Date());
        complainRequest.setSupplier(orderItem.getProduct().getSupplier());
