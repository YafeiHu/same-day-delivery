 ...
 * @author hyf
 */
public class ReturnAfterJPanel extends javax.swing.JPanel {
    ...
    UserAccount user;
    OrderItem orderItem;
    ReturnAfterRequest returnRequest;

    public ReturnAfterJPanel(JPanel userProcessContainer, Order order, OrderItem orderItem, UserAccount user, AmazonSystem system) {
        initComponents();
        ...
        this.user = user;
        returnRequest = new ReturnAfterRequest();
