...
public class RepairRequestJPanel extends javax.swing.JPanel {
    ...
    public RepairRequestJPanel(JPanel userProcessContainer, UserAccount account) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for (WorkRequest request : account.getWorkQueue().getWorkRequestList()) {
            if (request instanceof RepairRequest) {
                ...
                row[4] = ((RepairRequest) request).getSender();
                row[5] = ((RepairRequest) request).getRequestDate();
                row[6] = ((RepairRequest) request).getStatus();
                model.addRow(row);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        returnJTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "reason", "describe", "receiver", "solve date", "status"
            }
        ) {
