 ...
 * @author hyf
 */
public class MostRateJPanel1 extends javax.swing.JPanel {
    ...
    public MostRateJPanel1(JPanel userProcessContainer,Enterprise enterprise) {
        initComponents();
                    ...
                    if (nodeinfo instanceof ProductDirectory) {
                        ...
                        for (ProductSubDirectory productSubDirectory : ((ProductDirectory) nodeinfo).getSubDirectoryList()) {
                            for (Product p : productSubDirectory.getProductList()) {
                                products.add(p);
                                sort = products;
                                poputaleProductTable(productSubDirectory.getMostPopularProduct(sort));
                            }
                        }
                        ...
                        for (Product p : ((ProductSubDirectory) nodeinfo).getProductList()) {
                            products.add(p);
                            sort = products;
                            poputaleProductTable(((ProductSubDirectory) nodeinfo).getMostPopularProduct(sort));
                        }
                    }
                }
            });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(61, 61, 61)
                        .addComponent(viewProdjButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
