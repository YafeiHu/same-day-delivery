...
public class ManageOrderJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageOrderJPanel(JPanel userProcessContainer, UserAccount user, SysSaleOrganization organization, AmazonSystem system) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (Order o : organization.getOrderlist().getOrders()) {
            ...
            row[0] = o;
            row[2] = o.getCustomer();
            row[3] = o.getSubtotalPrice();
            row[4] = o.tax();
            row[5] = o.shipping();
            row[6] = o.totalMoney();
            row[7] = o.getOrderDate();
            row[8] = o.getShipment().getStatus();
            model.addRow(row);
        }
    }
